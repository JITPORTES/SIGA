...
public function workflow_reubicacion($Aceptado, $Id_Workflow_Reubicacion_Activo, $Paso){
	$Siga_reubicacion_activoController = new Siga_reubicacion_activoController();
	return $Siga_reubicacion_activoController->workflow_reubicacion($Aceptado, $Id_Workflow_Reubicacion_Activo, $Paso);
}
public function getworkflow_reubicacion($Id_Activo_Reubicacion){
	$Siga_reubicacion_activoController = new Siga_reubicacion_activoController();
	$val=$Siga_reubicacion_activoController->getworkflow_reubicacion($Id_Activo_Reubicacion);
    
    $jsonDto = new Encode_JSON();
	return $jsonDto->encode($val);
}
...
@$Id_Workflow_Reubicacion_Activo=$_POST["Id_Workflow_Reubicacion_Activo"];
@$Paso=$_POST["Paso"];
@$accion=$_POST["accion"];
...
$siga_reubicacion_activoDto=$siga_reubicacion_activoFacade->selectSiga_reubicacion_activo($siga_reubicacion_activoDto);
echo $siga_reubicacion_activoDto;
}else if($accion=="workflow_reubicacion") {
	echo $siga_reubicacion_activoFacade->workflow_reubicacion($Aceptado, $Id_Workflow_Reubicacion_Activo, $Paso);
}else if($accion=="getworkflow_reubicacion") {
	echo $siga_reubicacion_activoFacade->getworkflow_reubicacion($Id_Activo_Reubicacion);
}
