...
public function getworkflow_alta($Id_Activo){
	$Siga_activosController = new Siga_activosController();
	$Siga_activosDto = $Siga_activosController->getworkflow_alta($Id_Activo);
...
return $year . "-" . $mes . "-" . $dia;
	...
	@$Num_Empleado_Solicitante=$_POST["Num_Empleado_Solicitante"];
...
// se agregaron estos tres campops Alex Arias 25/04/24 $newDate = date("Y/m/d", strtotime($_POST["siga_activo_alta_fch_operacion"]))
	...
	$siga_activosDto->setNum_Empleado_Solicitante($Num_Empleado_Solicitante);
