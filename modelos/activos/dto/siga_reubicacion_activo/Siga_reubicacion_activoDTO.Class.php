<?php
 class Siga_reubicacion_activoDTO {
    ...
    private $Nom_Usuario_Reponsable;
		private $No_Empleado_Solicitante;
    ...
    public function setNom_Usuario_Reponsable($Nom_Usuario_Reponsable){
		...
		public function getNo_Empleado_Solicitante(){
        return $this->No_Empleado_Solicitante;
    }
    public function setNo_Empleado_Solicitante($No_Empleado_Solicitante){
        $this->No_Empleado_Solicitante=$No_Empleado_Solicitante;
    }
...
"No_Empleado_Solicitante"=>$this->No_Empleado_Solicitante,
