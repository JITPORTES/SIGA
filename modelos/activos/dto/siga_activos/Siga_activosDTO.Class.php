<?php
 class Siga_activosDTO {
    ...
    private $Num_Empleado;
		private $Num_Empleado_Solicitante;
    ...
    public function setNum_Empleado($Num_Empleado){
		...
		public function getNum_Empleado_Solicitante(){
        return $this->Num_Empleado_Solicitante;
    }
    public function setNum_Empleado_Solicitante($Num_Empleado_Solicitante){
        $this->Num_Empleado_Solicitante=$Num_Empleado_Solicitante;
    }
...
"Num_Empleado_Solicitante"=>$this->Num_Empleado_Solicitante,
