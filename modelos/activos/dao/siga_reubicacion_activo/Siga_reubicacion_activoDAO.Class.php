...
$sql="SELECT Id_Activo_Reubicacion,Id_Activo,Id_Area,Id_Ubic_Prim,Id_Ubic_Sec,Ubic_Especifica,Id_Usuario_Responsable,Nom_Usuario_Reponsable,No_Empleado_Solicitante,Centro_Costos,Jefe_Area,Motivo_Reubicacion,Comentarios_Reubicacion,Fech_Inser,Usr_Inser,Fech_Mod,Usr_Mod,Estatus_Reg FROM siga_reubicacion_activo ";
...
$tmp[$contador]->setNo_Empleado_Solicitante(rtrim(ltrim($row["No_Empleado_Solicitante"])));
