					...
					"columns": [
						{
							...
							"data": function (obj) {
								...
								<?php }
									...
									if(obj.WRId_Reubicacion_Activo!=null){
										opciones.push('<div class="text-center"><span class="cursor-pointer" onclick="workflowreubicaciones(' + obj.WRId_Reubicacion_Activo + ')"><i style="color:blue; font-size: 14px" class="fa fa-sitemap" aria-hidden="true" ></i></span></div>');
									}
