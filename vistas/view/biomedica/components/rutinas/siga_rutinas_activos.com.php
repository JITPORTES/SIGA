    ...
    $.ajax({
      ...
      success: function (response) {        
        ...
        response.forEach(function(activos, index) {
          ...
          activosEncontrados.push("<td><input type='date' name='fecha"+i+"' id='fecha"+i+"' style='' onkeydown='return false'; required min='<?php $date = new DateTime(); $date->modify('+1 day'); echo $date->format('Y-m-d');?>' value='<?php $date = new DateTime(); $date->modify('+1 day'); echo $date->format('Y-m-d');?>'></td>");
