...
<input type="file" id="miImagen">
<button class="btn btn-success btn-sm" id="redimencionar">+ Agregar</button>
...
$('#redimencionar').on('click', function(){

let formData 	= new FormData(); 	
let miImagen 		= $('#miImagen').prop("files")[0];

	formData.append('accion', 1);
	formData.append('miImagen', miImagen);

	$.ajax({
	type: "POST",
	url: "/siga/class/pruebas.ajax.php",
				data: formData,
				cache: false,
				processData: false,
				contentType: false,  
