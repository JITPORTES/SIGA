							...
							<div class="row">
								<div class="col-md-10 col-md-offset-1">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											...
											<select id="numempleadoresguardo" class="demo-default" placeholder="Usuario Resguardo" style="display:none"></select>
								...
								<div class="col-md-4">
									...
									<div class="form-group">
										...
										<div class="form-group">
											<span><font color="red">*</font></span><label for="numempleadosolicitante" class="control-label" id="numempleadosolicitanteLabel" style="font-size: 11px;">Usuario Solicitante</label>
											<select id="numempleadosolicitante" class="demo-default" placeholder="Usuario Solicitante" style="display:none"></select>
											<div id="gifcargandoaltausuariossolicitantes" style="display:none" align="center">
												<img src="../dist/img/cargando-loading.gif" style="max-width: 25px; max-height: 25px" alt="cargando-loading-037.gif">
											</div>
										</div>
									</div>
										...
										<div class="col-md-3">
												...
												<div class="box box-widget widget-user-2">													
													<div class="widget-user-header bg-green">
														...
														<h5 class="widget-user-desc">Puesto</h5>
													</div>
													<div class="box-footer no-padding">
														<ul class="nav nav-stacked">
															<li><a href="#">Fecha: <span class="pull-right badge bg-blue">31</span></a></li>
															<li><a href="#">Comentarios <span class="pull-right badge bg-aqua">5</span></a></li>
														</ul>
													</div>
												</div>
...
<div class="modal fade modalchs" id="workflowalta" data-backdrop="false">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<!-- ==== Titulo de la Ventana Modal ==== -->
			<div class="modal-header verde">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title"><i class="fa fa-arrow-circle-o-down" aria-hidden="true"></i> Seguimiento Alta de Activos</h4>
			</div>
			...
			<div class="modal-body nopsides">
					...
					<form>
							...
							<div class="process">
								<div class="process-row nav nav-tabs" id="wflalta">
