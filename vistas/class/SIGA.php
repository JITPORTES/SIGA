...
class SIGA 
{
	...
	public function workflowAlta($Id_Activo, $CveWorkFlow)
	{
	   ...
	   $query_rs = "
			 select 
				top 1 wa.Id_Alta_Activo, wa.CveWorkflow, wa.DescWorflow, rtrim(ltrim(wa.Correo)), wa.Nombre, No_Empleado, wa.Aceptado, 
				ca.Nom_Area, 
	...
	public function workflowReubicacion($Id_Reubicacion_Activo, $CveWorkFlow)
	{
