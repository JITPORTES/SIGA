		...
		<div class="modal-dialog modal-lg">
			...
			<div class="modal-content">
			  <div class="modal-header azuldef">
					...
					<h4 class="modal-title"><i class="fa fa-check-circle-o" aria-hidden="true"></i> Cancelación de Ticket con Folio:(1328) <label id="cancelacion_folio"></label> </h4>
				</div>
...
//==============================================================================================================================================================================================================	
	...
	let Id_Solicitud = $("#hdd_Id_Solicitud").val();
		var encontrado=0;
						...
						confirm: function () {
							$.ajax({
								...
								success: function (data) {
									...
									enviarEmail(1,'',Id_Solicitud,$("#Motivo_Cancelacion").val());
...
//Comendatado por instrucciones de Joaquin Palacio 13-06-2025
...
//============================================================================================================================================================================================================
		...
		if(validar){
			$.ajax({
				...
				error:function(response){
					$('#loadingState').hide();					
					mensajesalerta("SIGA: ", "Ocurrio un error al validar rutina(10505).", "error", "dark");
				}
...
function enviarEmail(tipo,email,id_solicitud,motivo){	
	
	$.ajax({
		type: "POST",
		url: "/siga/class/admin/email/email.ajax.php",
		data: {accion: 1, tipo:tipo, email:email, id_solicitud:id_solicitud,motivo:motivo},
		dataType: "JSON",
		async: false,
		cache: false,
		beforeSend: function(){
