...
$(document).ready(function(){
	...
	$.ajax({
		type: "POST",
		url: "/siga/class/class/utilities.ajax.php",
		data: {accion:1, Id_Usuario : $("#usuariosesion").val()},
		dataType: "JSON",
		success: function (response) {
			console.log(response);
			$('#sigaResultado').val(response);
		}
	});
...
//=================================================================================================================================================================================================
	...
	function tabla_activos_externos(){
			let sigaResultado = $('#sigaResultado').val();
			$.ajax({
				type: "POST",
				url: "../fachadas/activos/siga_activos/Siga_activosFacade.Class.php",
				data: {
