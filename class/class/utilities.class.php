...
function getPermisoGestorSrRenta($Id_usuario){
  $pdo = conectar::ConexionGestafSiga();

  $sql = "SELECT COUNT(Id_Gestor) permiso FROM siga_cat_gestores WHERE Id_Usuario = 5 AND Id_Seccion=3 AND Tipo_Gestor=1";
